...
/* themes/movies/templates/content/node.html.twig */
class __TwigTemplate_17ca013d165fdccd5dbcf59c192fc773db05884220b2d1bcdb8ed96bfe35e872 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
($context["view_mode"] ?? null)) ? (("node--view-mode-" . \Drupal\Component\Utility\Html::getClass($this->sandbox->ensureToStringAllowed(($context["view_mode"] ?? null), 77, $this->source)))) : (""))];
        // line 80
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->extensions['Drupal\Core\Template\TwigExtension']->attachLibrary("movies/node"), "html", null, true);
        echo "
<article";
        // line 81
...
";
    ...
    {
        return "themes/movies/templates/content/node.html.twig";
    }
    ...
    {
        return new Source("", "themes/movies/templates/content/node.html.twig", "/home/diego/dev/pessoal/projects/ntt_data/movies/web/themes/movies/templates/content/node.html.twig");
    }
